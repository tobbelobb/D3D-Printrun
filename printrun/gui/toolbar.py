...
def MainToolbar(root, parentpanel = None, use_wrapsizer = False, reduced = False):
    ...
    self.Add(wx.StaticText(parentpanel, -1, " to "), 0, wx.RIGHT | wx.ALIGN_CENTER, 0)

    root.rescanbtn = make_autosize_button(parentpanel, _("Port"), root.rescanports, _("Click to rescan ports"))
    ...
    self.Add(wx.StaticText(parentpanel, -1, " at baud rate "), 0, wx.RIGHT | wx.ALIGN_CENTER, 0)
